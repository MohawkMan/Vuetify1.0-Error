...
<script>
  export default {
    ...
    computed: {
      ...
      items () {
        return [
        { icon: 'account_circle', text: this.userFullName, to: 'profile' },
        { icon: 'people', text: 'Players', to: 'players' },
        { icon: 'format_list_numbered', text: 'Rankings', to: 'rankings' },
        { icon: 'date_range', text: 'Tournaments', to: 'tournaments' },
        { icon: 'apps', text: 'Organizations', to: 'organizations' }
        ]
      },
      myItems () {
        return [
          { icon: 'account_circle', text: 'My Profile', to: 'profile' },
          { icon: 'date_range', text: 'My Tournaments', to: 'profile' }
        ]
      },
      userFullName () {
